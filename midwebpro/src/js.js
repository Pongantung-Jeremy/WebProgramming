...
const programs = {
  filsafat:['theology bachelors','magister of theology'],
  keperawatan:['bachelor nursing','proffession'],
  pertanian:['agriculture'],
  fik:['system information','information of technology'],
  ubs:['accounting','management','international program'],
  asmi:['secretary'],
  pendidikan:['religious education','english education','economic education','non-formal education']
}
